...
### ✨ - Matching
Our system randomly matches students into groups **[TODO: add size]** 1 hour before their common lunchtime, and invite them to share a table. Users can limit their search by specified characteristics, e.g. if they are only willing to meet up with people from the same degree.
...
He signs into Meet@Mensa and indicates that he’s particularly looking for 2 other people involved in the Interdisciplinary Project this semester. He selects lunchtime on Thursday and fills out his profile with relevant classes and hobbies, including his passion for design and urban mobility.
