...
public class MatchingApi {
    ...
    /**
     * Build call for deleteApiV2MatchingMatchesRequestId
     ...
     */
    public okhttp3.Call deleteApiV2MatchingMatchesRequestIdCall(@javax.annotation.Nonnull UUID requestId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteApiV2MatchingMatchesRequestIdValidateBeforeCall(@javax.annotation.Nonnull UUID requestId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestId' is set
        if (requestId == null) {
            throw new ApiException("Missing the required parameter 'requestId' when calling deleteApiV2MatchingMatchesRequestId(Async)");
        }

        return deleteApiV2MatchingMatchesRequestIdCall(requestId, _callback);
     ...
     */
    public void deleteApiV2MatchingMatchesRequestId(@javax.annotation.Nonnull UUID requestId) throws ApiException {
        deleteApiV2MatchingMatchesRequestIdWithHttpInfo(requestId);
    }
     ...
     */
    public ApiResponse<Void> deleteApiV2MatchingMatchesRequestIdWithHttpInfo(@javax.annotation.Nonnull UUID requestId) throws ApiException {
        okhttp3.Call localVarCall = deleteApiV2MatchingMatchesRequestIdValidateBeforeCall(requestId, null);
     ...
     */
    public okhttp3.Call deleteApiV2MatchingMatchesRequestIdAsync(@javax.annotation.Nonnull UUID requestId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteApiV2MatchingMatchesRequestIdValidateBeforeCall(requestId, _callback);
    ...
    /**
     * Build call for postApiV2MatchingRequest
     ...
     */
    public okhttp3.Call postApiV2MatchingRequestCall(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postApiV2MatchingRequestValidateBeforeCall(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback _callback) throws ApiException {
        return postApiV2MatchingRequestCall(matchRequestNew, _callback);
     ...
     */
    public void postApiV2MatchingRequest(@javax.annotation.Nullable MatchRequestNew matchRequestNew) throws ApiException {
        postApiV2MatchingRequestWithHttpInfo(matchRequestNew);
    }
     ...
     */
    public ApiResponse<Void> postApiV2MatchingRequestWithHttpInfo(@javax.annotation.Nullable MatchRequestNew matchRequestNew) throws ApiException {
        okhttp3.Call localVarCall = postApiV2MatchingRequestValidateBeforeCall(matchRequestNew, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call postApiV2MatchingRequestAsync(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = postApiV2MatchingRequestValidateBeforeCall(matchRequestNew, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
