...
public class MatchingApi {
    ...
    /**
     * Build call for postApiV2MatchingDemo
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> User already has a meeting on this day! </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call postApiV2MatchingDemoCall(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/matching/demo";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postApiV2MatchingDemoValidateBeforeCall(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback _callback) throws ApiException {
        return postApiV2MatchingDemoCall(matchRequestNew, _callback);
     ...
     */
    public Group postApiV2MatchingDemo(@javax.annotation.Nullable MatchRequestNew matchRequestNew) throws ApiException {
        ApiResponse<Group> localVarResp = postApiV2MatchingDemoWithHttpInfo(matchRequestNew);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Group> postApiV2MatchingDemoWithHttpInfo(@javax.annotation.Nullable MatchRequestNew matchRequestNew) throws ApiException {
        okhttp3.Call localVarCall = postApiV2MatchingDemoValidateBeforeCall(matchRequestNew, null);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create demo request (asynchronously)
     * Submit a match request which will be immediately matched with a group of demo users.
     * @param matchRequestNew  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call postApiV2MatchingDemoAsync(@javax.annotation.Nullable MatchRequestNew matchRequestNew, final ApiCallback<Group> _callback) throws ApiException {

        okhttp3.Call localVarCall = postApiV2MatchingDemoValidateBeforeCall(matchRequestNew, _callback);
        Type localVarReturnType = new TypeToken<Group>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
