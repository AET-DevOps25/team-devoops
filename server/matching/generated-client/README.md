...
MeetAtMensa
- API version: 2.2.1
  - Build date: 2025-07-07T12:54:03.187159639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools.client:openapi-client-matching:2.2.1"
  }
```
...
* `target/openapi-client-matching-2.2.1.jar`
* `target/lib/*.jar`
