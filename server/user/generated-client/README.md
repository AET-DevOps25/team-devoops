...
MeetAtMensa
- API version: 2.1.4
  - Build date: 2025-07-01T11:47:31.922653007Z[Etc/UTC]
...
<dependency>
  ...
  <artifactId>openapi-client-user</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'openapi-client-user' jar has been published to maven central.
    mavenLocal()       // Needed if the 'openapi-client-user' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools.client:openapi-client-user:2.1.4"
  }
```
...
* `target/openapi-client-user-2.1.4.jar`
* `target/lib/*.jar`
