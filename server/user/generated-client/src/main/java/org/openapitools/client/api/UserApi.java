...
public class UserApi {
    ...
    /**
     * Build call for getApiV2UsersDemo
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getApiV2UsersDemoCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v2/users/demo";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getApiV2UsersDemoValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getApiV2UsersDemoCall(_callback);
     ...
     */
    public UserCollection getApiV2UsersDemo() throws ApiException {
        ApiResponse<UserCollection> localVarResp = getApiV2UsersDemoWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UserCollection> getApiV2UsersDemoWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getApiV2UsersDemoValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<UserCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get demo users (asynchronously)
     * Return 3 demo-users in a UserCollection
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getApiV2UsersDemoAsync(final ApiCallback<UserCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getApiV2UsersDemoValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<UserCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
