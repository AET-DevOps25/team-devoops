...
MeetAtMensa
- API version: 2.3.0
  - Build date: 2025-07-19T16:54:44.648991243Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools.client:openapi-client-gateway:2.3.0"
  }
```
...
* `target/openapi-client-gateway-2.3.0.jar`
* `target/lib/*.jar`
