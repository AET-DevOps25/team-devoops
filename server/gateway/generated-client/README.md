...
MeetAtMensa
- API version: 2.1.5
  - Build date: 2025-07-01T14:30:52.811533401Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools.client:openapi-client-gateway:2.1.5"
  }
```
...
* `target/openapi-client-gateway-2.1.5.jar`
* `target/lib/*.jar`
